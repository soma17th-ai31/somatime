  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(buttonVariants({ variant: 'ghost', size: 'icon' }), 'size-8 text-muted-foreground hover:text-foreground'),
        button_next: cn(buttonVariants({ variant: 'ghost', size: 'icon' }), 'size-8 text-muted-foreground hover:text-foreground'),
      ...
      components={{
        Chevron: ({ orientation, className: iconClassName }) => (orientation === 'left' ? <ChevronLeft className={cn('size-4', iconClassName)} /> : <ChevronRight className={cn('size-4', iconClassName)} />),
      }}
      {...props}
    />
  );
